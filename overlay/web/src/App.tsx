...
const BUILTIN_NAV_REST: NavItem[] = [
  ...
  { path: "/rooms", label: "Nhóm", icon: Users },
  ...
  { path: "/cron-health", label: "Sức khoẻ lịch", icon: Heart },
...
export default function App() {
  ...
  // Trang Nhóm tự quản chiều cao: khung tin nhắn có thanh cuộn riêng, còn
  // tiêu đề và ô soạn tin đứng yên. Muốn vậy thì mọi khung bọc phía trên nó
  // phải có chiều cao XÁC ĐỊNH — chỉ /chat và /docs được như thế, nên trước
  // đây `height: 100%` của trang Nhóm rơi về `auto`, khung tin nhắn không bao
  // giờ cuộn, và anh phải cuộn CẢ TRANG mới với tới ô soạn tin.
  const isRoomsRoute = normalizedPath === "/rooms";
  const isFullHeightRoute = isDocsRoute || isChatRoute || isRoomsRoute;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="hermes-command-mobile-brand">
          <strong>HERMES MAX</strong>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="hermes-command-brand">
                  <div className="hermes-command-brand-mark" aria-hidden>
                    <Sparkles className="h-4 w-4" />
                  </div>
                  <div>
                    <Typography className="hermes-command-brand-title">
                      HERMES MAX
                    </Typography>
                    <span className="hermes-command-brand-subtitle">
          ...
          <PageHeaderProvider pluginTabs={pluginTabMeta}>
            <div
              className={cn(
                ...
                isRoomsRoute && "pb-0",
                (isDocsRoute || isRoomsRoute) && "min-h-0 flex-1",
              )}
            >
